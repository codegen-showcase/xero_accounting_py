...
res = client.accounting.items.delete(
...
res = await client.accounting.items.delete(
    item_id="00000000-0000-0000-0000-000000000000", xero_tenant_id="YOUR_XERO_TENANT_ID"
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.list(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Code ASC",
    unitdp=4,
    where="IsSold==true",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.get(
    item_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    unitdp=4,
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    items=[
        {
            "code": "ItemCode123",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    items=[
        {
            "code": "ItemCode123",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.update(
    item_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.update(
    item_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    items=[{"code": "ItemCode123", "description": "Description 123"}],
    unitdp=4,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    items=[
        {
            "code": "code123",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    items=[
        {
            "code": "code123",
