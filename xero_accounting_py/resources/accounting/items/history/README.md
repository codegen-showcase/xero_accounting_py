...
res = client.accounting.items.history.list(
...
res = await client.accounting.items.history.list(
    item_id="00000000-0000-0000-0000-000000000000", xero_tenant_id="YOUR_XERO_TENANT_ID"
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.items.history.create_record(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.items.history.create_record(
    item_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    history_records=[{"details": "Hello World"}],
)
