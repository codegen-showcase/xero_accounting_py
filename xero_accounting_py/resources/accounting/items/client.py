...
from xero_accounting_py.resources.accounting.items.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class ItemsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.items.delete(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.items.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            items=[
                {
                    "code": "ItemCode123",
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.items.update(
            item_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncItemsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.items.delete(
            item_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.items.get(
            item_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            unitdp=4,
        )
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.items.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            items=[
                {
                    "code": "ItemCode123",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.items.update(
            item_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            items=[{"code": "ItemCode123", "description": "Description 123"}],
            unitdp=4,
