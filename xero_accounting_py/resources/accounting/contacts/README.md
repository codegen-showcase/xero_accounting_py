...
res = client.accounting.contacts.list(
...
res = await client.accounting.contacts.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    include_archived=True,
    order="Name ASC",
    page=1,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contacts.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contacts.get(
    contact_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contacts.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contacts=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contacts.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contacts=[
        {
            "email_address": "hulk@avengers.com",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contacts.update(
    contact_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contacts.update(
    contact_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contacts=[{"contact_id": "00000000-0000-0000-0000-000000000000", "name": "Thanos"}],
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contacts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contacts=[
        {
            "addresses": [
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contacts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contacts=[
        {
            "addresses": [
