...
from xero_accounting_py.resources.accounting.contacts.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.contacts.cis_settings import (
    AsyncCisSettingsClient,
    CisSettingsClient,
)
from xero_accounting_py.resources.accounting.contacts.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class ContactsClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contacts.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contacts.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
                {
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contacts.update(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
...
class AsyncContactsClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contacts.get(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contacts.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
                {
                    "email_address": "hulk@avengers.com",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contacts.update(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
                {"contact_id": "00000000-0000-0000-0000-000000000000", "name": "Thanos"}
