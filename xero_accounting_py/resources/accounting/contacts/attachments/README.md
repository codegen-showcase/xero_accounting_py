# accounting.contacts.attachments
...
res = client.accounting.contacts.attachments.list(
...
res = await client.accounting.contacts.attachments.list(
    contact_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contacts.attachments.get_by_id(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contacts.attachments.get_by_id(
    attachment_id="00000000-0000-0000-0000-000000000000",
    contact_id="00000000-0000-0000-0000-000000000000",
    content_type="image/jpg",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
