...
class AttachmentsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contacts.attachments.list(
    ...
    def get_by_id(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contacts.attachments.get_by_id(
...
class AsyncAttachmentsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contacts.attachments.list(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get_by_id(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contacts.attachments.get_by_id(
            attachment_id="00000000-0000-0000-0000-000000000000",
            contact_id="00000000-0000-0000-0000-000000000000",
            content_type="image/jpg",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
