...
from xero_accounting_py.resources.accounting.manual_journals.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.manual_journals.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class ManualJournalsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.manual_journals.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.manual_journals.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.manual_journals.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
                    "date": "2019-03-14",
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.manual_journals.update(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.manual_journals.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
                    "date": "2019-03-14",
...
class AsyncManualJournalsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.manual_journals.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Date ASC",
            page=1,
            page_size=100,
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.manual_journals.get(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.manual_journals.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
                    "date": "2019-03-14",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.manual_journals.update(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.manual_journals.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            manual_journals=[
                {
                    "date": "2019-03-14",
