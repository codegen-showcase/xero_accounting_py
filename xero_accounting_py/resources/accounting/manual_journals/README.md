...
res = client.accounting.manual_journals.list(
...
res = await client.accounting.manual_journals.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Date ASC",
    page=1,
    page_size=100,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.manual_journals.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.manual_journals.get(
    manual_journal_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.manual_journals.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
            "date": "2019-03-14",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.manual_journals.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
            "date": "2019-03-14",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.manual_journals.update(
    manual_journal_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.manual_journals.update(
    manual_journal_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.manual_journals.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
            "date": "2019-03-14",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.manual_journals.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    manual_journals=[
        {
            "date": "2019-03-14",
