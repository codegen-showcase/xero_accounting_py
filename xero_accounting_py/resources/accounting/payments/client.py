...
from xero_accounting_py.resources.accounting.payments.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class PaymentsClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.payments.get(
    ...
    def create_1(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.payments.create_1(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.payments.delete(
            payment_id="00000000-0000-0000-0000-000000000000",
            status="string",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
...
class AsyncPaymentsClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.payments.get(
            payment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create_1(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.payments.create_1(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            has_account=False,
            has_validation_errors=False,
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.payments.delete(
            payment_id="00000000-0000-0000-0000-000000000000",
            status="string",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
