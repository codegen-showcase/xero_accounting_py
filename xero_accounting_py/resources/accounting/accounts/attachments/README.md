# accounting.accounts.attachments
...
res = client.accounting.accounts.attachments.list(
...
res = await client.accounting.accounts.attachments.list(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.accounts.attachments.get_by_id(
    account_id="00000000-0000-0000-0000-000000000000",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.accounts.attachments.get_by_id(
    account_id="00000000-0000-0000-0000-000000000000",
    attachment_id="00000000-0000-0000-0000-000000000000",
    content_type="image/jpg",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
