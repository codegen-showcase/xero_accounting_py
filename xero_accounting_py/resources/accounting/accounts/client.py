...
from xero_accounting_py.resources.accounting.accounts.attachments import (
...
class AccountsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.accounts.delete(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.accounts.get(
            account_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.accounts.update(
            account_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            accounts=[
                {
    ...
    def create(
        ...
        *,
        ...
        Args:
            ...
            currency_code: 3 letter alpha code for the ISO-4217 currency code, e.g. USD, AUD.
...
class AsyncAccountsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.accounts.delete(
            account_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.accounts.get(
            account_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.accounts.update(
            account_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            accounts=[
                {
