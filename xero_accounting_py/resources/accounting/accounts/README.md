...
res = client.accounting.accounts.delete(
...
res = await client.accounting.accounts.delete(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.accounts.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Name ASC",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.accounts.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Name ASC",
    where="Status==&quot;ACTIVE&quot; AND Type==&quot;BANK&quot;",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.accounts.get(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.accounts.get(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
| `account_id`     |    ✓     | Unique identifier for Account object | `"00000000-0000-0000-0000-000000000000"`                                                                                                                                                        |
| `xero_tenant_id` |    ✓     | Xero identifier for Tenant           | `"YOUR_XERO_TENANT_ID"`                                                                                                                                                                         |
| `accounts`       |    ✗     |                                      | `[{"account_id": "00000000-0000-0000-0000-000000000000", "code": "4400", "currency_code": "AUD", "has_attachments": False, "name": "Food Sales", "updated_date_utc": "/Date(1573755038314)/"}]` |
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.accounts.update(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    accounts=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.accounts.update(
    account_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    accounts=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.accounts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    account_id="00000000-0000-0000-0000-000000000000",
    code="123456",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.accounts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    account_id="00000000-0000-0000-0000-000000000000",
    code="123456",
    description="Hello World",
