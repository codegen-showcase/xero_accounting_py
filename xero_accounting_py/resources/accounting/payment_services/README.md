...
res = client.accounting.payment_services.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
res = await client.accounting.payment_services.list(
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.payment_services.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    payment_services=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.payment_services.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    payment_services=[
        {
            "pay_now_text": "Time To Pay",
