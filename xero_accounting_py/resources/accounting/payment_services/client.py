...
class PaymentServicesClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.payment_services.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
        ```
        """
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.payment_services.create(
...
class AsyncPaymentServicesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.payment_services.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID"
        )
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.payment_services.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            payment_services=[
                {
                    "pay_now_text": "Time To Pay",
