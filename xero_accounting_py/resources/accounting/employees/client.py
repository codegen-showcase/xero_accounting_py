...
class EmployeesClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.employees.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.employees.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            employees=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.employees.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            employees=[
                {
                    "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
...
class AsyncEmployeesClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.employees.get(
            employee_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.employees.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            employees=[
                {
                    "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.employees.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            employees=[
                {
                    "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
