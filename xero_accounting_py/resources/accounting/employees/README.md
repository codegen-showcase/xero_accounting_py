...
res = client.accounting.employees.list(
...
res = await client.accounting.employees.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", order="LastName ASC", where='Status=="ACTIVE"'
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.employees.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.employees.get(
    employee_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.employees.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    employees=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.employees.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    employees=[
        {
            "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.employees.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    employees=[
        {
            "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.employees.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    employees=[
        {
            "external_link": {"url": "http://twitter.com/#!/search/Nick+Fury"},
