...
from xero_accounting_py.resources.accounting.overpayments.allocations import (
    AllocationsClient,
    AsyncAllocationsClient,
)
from xero_accounting_py.resources.accounting.overpayments.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class OverpaymentsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.overpayments.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.overpayments.get(
...
class AsyncOverpaymentsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.overpayments.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Status ASC",
            page=1,
            page_size=100,
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.overpayments.get(
            overpayment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
