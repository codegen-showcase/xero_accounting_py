...
from xero_accounting_py.resources.accounting.batch_payments.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class BatchPaymentsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.batch_payments.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.batch_payments.get(
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.batch_payments.delete(
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.batch_payments.update(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            status="DELETED",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.batch_payments.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            batch_payments=[
                {
...
class AsyncBatchPaymentsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.batch_payments.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Date ASC",
            where='Status=="AUTHORISED"',
        )
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.batch_payments.get(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.batch_payments.delete(
            batch_payment_id="9bf296e9-0748-4d29-a3dc-24dde1098030",
            status="DELETED",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.batch_payments.update(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            status="DELETED",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.batch_payments.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            batch_payments=[
                {
                    "account": {"account_id": "00000000-0000-0000-0000-000000000000"},
