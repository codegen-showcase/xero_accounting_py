...
res = client.accounting.batch_payments.list(
...
res = await client.accounting.batch_payments.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", order="Date ASC", where='Status=="AUTHORISED"'
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.batch_payments.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.batch_payments.get(
    batch_payment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.batch_payments.delete(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.batch_payments.delete(
    batch_payment_id="9bf296e9-0748-4d29-a3dc-24dde1098030",
    status="DELETED",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.batch_payments.update(
    batch_payment_id="00000000-0000-0000-0000-000000000000",
    status="DELETED",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.batch_payments.update(
    batch_payment_id="00000000-0000-0000-0000-000000000000",
    status="DELETED",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.batch_payments.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    batch_payments=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.batch_payments.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    batch_payments=[
        {
            "account": {"account_id": "00000000-0000-0000-0000-000000000000"},
