...
res = client.accounting.branding_themes.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
res = await client.accounting.branding_themes.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.branding_themes.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.branding_themes.get(
    branding_theme_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
