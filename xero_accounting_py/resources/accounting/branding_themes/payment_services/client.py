...
class PaymentServicesClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.branding_themes.payment_services.list(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.branding_themes.payment_services.create(
            branding_theme_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            payment_services=[
                {
...
class AsyncPaymentServicesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.branding_themes.payment_services.list(
            branding_theme_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.branding_themes.payment_services.create(
            branding_theme_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            payment_services=[
                {
