# accounting.branding_themes.payment_services
...
res = client.accounting.branding_themes.payment_services.list(
...
res = await client.accounting.branding_themes.payment_services.list(
    branding_theme_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.branding_themes.payment_services.create(
    branding_theme_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    payment_services=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.branding_themes.payment_services.create(
    branding_theme_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    payment_services=[
        {
