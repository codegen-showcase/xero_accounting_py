...
from xero_accounting_py.resources.accounting.branding_themes.payment_services import (
...
class BrandingThemesClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.branding_themes.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
        ```
        """
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.branding_themes.get(
...
class AsyncBrandingThemesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.branding_themes.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID"
        )
        ```
        """
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.branding_themes.get(
            branding_theme_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
