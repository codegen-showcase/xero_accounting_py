...
class CurrenciesClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.currencies.list(
    ...
    def create(
        ...
        *,
        ...
        Args:
            code: 3 letter alpha code for the ISO-4217 currency code, e.g. USD, AUD.
        ...
        Examples:
        ```py
        client.accounting.currencies.create(
...
class AsyncCurrenciesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.currencies.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID", order="Code ASC", where='Code=="USD"'
        )
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.currencies.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            code="USD",
            description="United States Dollar",
        )
