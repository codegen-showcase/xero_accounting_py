...
res = client.accounting.tax_rates.list(
...
res = await client.accounting.tax_rates.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", order="Name ASC", where='Status=="ACTIVE"'
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tax_rates.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tax_rates.get(
    tax_type="INPUT2", xero_tenant_id="YOUR_XERO_TENANT_ID"
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tax_rates.update(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tax_rates.update(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    tax_rates=[
        {
            "name": "State Tax NY",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tax_rates.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    tax_rates=[
        {
            "name": "CA State Tax",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tax_rates.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    tax_rates=[
        {
            "name": "CA State Tax",
