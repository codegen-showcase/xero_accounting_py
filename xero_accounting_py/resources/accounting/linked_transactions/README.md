# accounting.linked_transactions
...
res = client.accounting.linked_transactions.delete(
...
res = await client.accounting.linked_transactions.delete(
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.linked_transactions.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.linked_transactions.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contact_id="00000000-0000-0000-0000-000000000000",
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    page=1,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.linked_transactions.get(
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.linked_transactions.get(
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.linked_transactions.update(
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    linked_transactions=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.linked_transactions.update(
    linked_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    linked_transactions=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.linked_transactions.create(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.linked_transactions.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID", updated_date_utc="/Date(1573755038314)/"
)
```
