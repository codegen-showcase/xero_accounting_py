...
class LinkedTransactionsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.linked_transactions.delete(
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.linked_transactions.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.linked_transactions.get(
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.linked_transactions.update(
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            linked_transactions=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.linked_transactions.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncLinkedTransactionsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.linked_transactions.delete(
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.linked_transactions.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contact_id="00000000-0000-0000-0000-000000000000",
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            page=1,
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.linked_transactions.get(
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.linked_transactions.update(
            linked_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            linked_transactions=[
                {
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.linked_transactions.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            updated_date_utc="/Date(1573755038314)/",
        )
        ```
