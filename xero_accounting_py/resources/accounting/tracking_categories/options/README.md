# accounting.tracking_categories.options
...
res = client.accounting.tracking_categories.options.delete(
...
res = await client.accounting.tracking_categories.options.delete(
    tracking_category_id="00000000-0000-0000-0000-000000000000",
    tracking_option_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.options.update(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.options.update(
    tracking_category_id_path="00000000-0000-0000-0000-000000000000",
    tracking_option_id_path="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.options.create(
    tracking_category_id_path="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.options.create(
    tracking_category_id_path="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
