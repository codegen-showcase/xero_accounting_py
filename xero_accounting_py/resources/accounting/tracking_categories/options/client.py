...
class OptionsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.options.delete(
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.options.update(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.options.create(
            tracking_category_id_path="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
...
class AsyncOptionsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.options.delete(
            tracking_category_id="00000000-0000-0000-0000-000000000000",
            tracking_option_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.options.update(
            tracking_category_id_path="00000000-0000-0000-0000-000000000000",
            tracking_option_id_path="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.options.create(
            tracking_category_id_path="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
