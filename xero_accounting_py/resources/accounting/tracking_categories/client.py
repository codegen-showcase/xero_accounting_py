...
from xero_accounting_py.resources.accounting.tracking_categories.options import (
    AsyncOptionsClient,
    OptionsClient,
)
...
class TrackingCategoriesClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.delete(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.get(
            tracking_category_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.update(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.tracking_categories.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID"
        )
        ```
        """
...
class AsyncTrackingCategoriesClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.delete(
            tracking_category_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.get(
            tracking_category_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.update(
            tracking_category_id_path="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            name="Avengers",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.tracking_categories.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID"
        )
        ```
        """
