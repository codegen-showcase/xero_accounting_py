...
res = client.accounting.tracking_categories.delete(
...
res = await client.accounting.tracking_categories.delete(
    tracking_category_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    include_archived=True,
    order="Name ASC",
    where='Status=="ACTIVE"',
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.get(
    tracking_category_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.get(
    tracking_category_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.update(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.update(
    tracking_category_id_path="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    name="Avengers",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.tracking_categories.create(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.tracking_categories.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID"
)
```
