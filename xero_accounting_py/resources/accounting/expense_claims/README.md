...
res = client.accounting.expense_claims.list(
...
res = await client.accounting.expense_claims.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Status ASC",
    where='Status=="SUBMITTED"',
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.expense_claims.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.expense_claims.get(
    expense_claim_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.expense_claims.update(
    expense_claim_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    expense_claims=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.expense_claims.update(
    expense_claim_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    expense_claims=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.expense_claims.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    expense_claims=[
        {
            "status": "SUBMITTED",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.expense_claims.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    expense_claims=[
        {
            "status": "SUBMITTED",
