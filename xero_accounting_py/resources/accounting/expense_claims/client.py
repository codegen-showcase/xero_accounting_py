...
from xero_accounting_py.resources.accounting.expense_claims.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class ExpenseClaimsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.expense_claims.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.expense_claims.get(
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.expense_claims.update(
            expense_claim_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            expense_claims=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.expense_claims.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            expense_claims=[
                {
                    "status": "SUBMITTED",
...
class AsyncExpenseClaimsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.expense_claims.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Status ASC",
            where='Status=="SUBMITTED"',
        )
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.expense_claims.get(
            expense_claim_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.expense_claims.update(
            expense_claim_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            expense_claims=[
                {
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.expense_claims.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            expense_claims=[
                {
                    "status": "SUBMITTED",
