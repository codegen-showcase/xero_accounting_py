...
res = client.accounting.bank_transactions.list(
...
res = await client.accounting.bank_transactions.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Type ASC",
    page=1,
    page_size=100,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transactions.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transactions.get(
    bank_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    unitdp=4,
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transactions.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transactions=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transactions.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transactions=[
        {
            "bank_account": {"code": "088"},
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transactions.update(
    bank_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transactions=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transactions.update(
    bank_transaction_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transactions=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transactions.create(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transactions.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID", summarize_errors=True, unitdp=4
)
```
