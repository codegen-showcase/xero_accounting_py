...
from xero_accounting_py.resources.accounting.bank_transactions.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.bank_transactions.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class BankTransactionsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transactions.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transactions.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transactions.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transactions=[
                {
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transactions.update(
            bank_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transactions=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transactions.create(
...
class AsyncBankTransactionsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transactions.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Type ASC",
            page=1,
            page_size=100,
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transactions.get(
            bank_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            unitdp=4,
        )
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transactions.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transactions=[
                {
                    "bank_account": {"code": "088"},
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transactions.update(
            bank_transaction_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transactions=[
                {
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transactions.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID", summarize_errors=True, unitdp=4
        )
        ```
        """
