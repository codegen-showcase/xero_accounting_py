...
from xero_accounting_py.resources.accounting.contact_groups.contacts import (
    AsyncContactsClient,
    ContactsClient,
)
...
class ContactGroupsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.get(
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.update(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.create(
...
class AsyncContactGroupsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Name ASC",
            where='Status=="ACTIVE"',
        )
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.get(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.update(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contact_groups=[{"name": "Suppliers"}],
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID", contact_groups=[{"name": "VIPs"}]
        )
        ```
        """
