...
class ContactsClient:
    ...
    def delete_all(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.contacts.delete_all(
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.contacts.delete(
            contact_group_id="00000000-0000-0000-0000-000000000000",
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.contact_groups.contacts.create(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
...
class AsyncContactsClient:
    ...
    async def delete_all(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.contacts.delete_all(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.contacts.delete(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.contact_groups.contacts.create(
            contact_group_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contacts=[
                {"contact_id": "a3675fc4-f8dd-4f03-ba5b-f1870566bcd7"},
