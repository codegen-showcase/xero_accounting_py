...
res = client.accounting.contact_groups.list(
...
res = await client.accounting.contact_groups.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", order="Name ASC", where='Status=="ACTIVE"'
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contact_groups.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contact_groups.get(
    contact_group_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contact_groups.update(
    contact_group_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contact_groups.update(
    contact_group_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contact_groups=[{"name": "Suppliers"}],
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.contact_groups.create(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.contact_groups.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID", contact_groups=[{"name": "VIPs"}]
)
```
