...
from xero_accounting_py.resources.accounting.prepayments.allocations import (
    AllocationsClient,
    AsyncAllocationsClient,
)
from xero_accounting_py.resources.accounting.prepayments.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class PrepaymentsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.prepayments.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.prepayments.get(
...
class AsyncPrepaymentsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.prepayments.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Reference ASC",
            page=1,
            page_size=100,
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.prepayments.get(
            prepayment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
