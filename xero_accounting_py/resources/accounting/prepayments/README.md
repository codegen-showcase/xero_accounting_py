...
res = client.accounting.prepayments.list(
...
res = await client.accounting.prepayments.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Reference ASC",
    page=1,
    page_size=100,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.prepayments.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.prepayments.get(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
