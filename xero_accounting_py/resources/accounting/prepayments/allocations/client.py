...
class AllocationsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.prepayments.allocations.delete(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.prepayments.allocations.create(
            prepayment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            allocations=[
                {
...
class AsyncAllocationsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.prepayments.allocations.delete(
            allocation_id="00000000-0000-0000-0000-000000000000",
            prepayment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.prepayments.allocations.create(
            prepayment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            allocations=[
                {
