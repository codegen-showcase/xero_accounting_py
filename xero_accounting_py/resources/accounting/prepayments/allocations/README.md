# accounting.prepayments.allocations
...
res = client.accounting.prepayments.allocations.delete(
...
res = await client.accounting.prepayments.allocations.delete(
    allocation_id="00000000-0000-0000-0000-000000000000",
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.prepayments.allocations.create(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    allocations=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.prepayments.allocations.create(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    allocations=[
        {
