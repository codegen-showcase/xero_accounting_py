# accounting.prepayments.history
...
res = client.accounting.prepayments.history.list(
...
res = await client.accounting.prepayments.history.list(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.prepayments.history.create_record(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.prepayments.history.create_record(
    prepayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    history_records=[{"details": "Hello World"}],
)
