...
from xero_accounting_py.resources.accounting.purchase_orders.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.purchase_orders.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class PurchaseOrdersClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            purchase_orders=[
                {
                    "date": "2019-03-13",
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.update(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            purchase_orders=[
                {
...
class AsyncPurchaseOrdersClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.get(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            purchase_orders=[
                {
                    "date": "2019-03-13",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.update(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            purchase_orders=[
                {
