...
class AttachmentsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.attachments.list(
    ...
    def get_by_id(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.attachments.get_by_id(
    ...
    def get_as_pdf(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.purchase_orders.attachments.get_as_pdf(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
...
class AsyncAttachmentsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.attachments.list(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get_by_id(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.attachments.get_by_id(
            attachment_id="00000000-0000-0000-0000-000000000000",
            content_type="image/jpg",
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    async def get_as_pdf(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.purchase_orders.attachments.get_as_pdf(
            purchase_order_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
