...
class ReportsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
        ```
        """
    ...
    def get_aged_payables_by_contact(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_aged_payables_by_contact(
    ...
    def get_aged_receivables_by_contact(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_aged_receivables_by_contact(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-10-31",
            from_date="2019-10-31",
    ...
    def get_balance_sheet(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_balance_sheet(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-11-01",
            payments_only=False,
            periods=3,
    ...
    def get_bank_summary(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_bank_summary(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            from_date="2019-10-31",
            to_date="2019-10-31",
        )
    ...
    def get_budget_summary(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_budget_summary(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-03-31",
            periods=2,
            timeframe=3,
    ...
    def get_executive_summary(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_executive_summary(
    ...
    def get_profit_and_loss(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_profit_and_loss(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            from_date="2019-10-31",
            payments_only=False,
            periods=3,
    ...
    def get_ten_ninety_nine(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_ten_ninety_nine(
    ...
    def get_trial_balance(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.reports.get_trial_balance(
...
class AsyncReportsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
        ```
        """
        _header: typing.Dict[str, str] = {}
        _header["xero-tenant-id"] = str(xero_tenant_id)
    ...
    async def get_aged_payables_by_contact(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_aged_payables_by_contact(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-10-31",
            from_date="2019-10-31",
    ...
    async def get_aged_receivables_by_contact(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_aged_receivables_by_contact(
            contact_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-10-31",
            from_date="2019-10-31",
    ...
    async def get_balance_sheet(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_balance_sheet(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-11-01",
            payments_only=False,
            periods=3,
    ...
    async def get_bank_summary(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_bank_summary(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            from_date="2019-10-31",
            to_date="2019-10-31",
        )
    ...
    async def get_budget_summary(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_budget_summary(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            date="2019-03-31",
            periods=2,
            timeframe=3,
    ...
    async def get_executive_summary(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_executive_summary(
            xero_tenant_id="YOUR_XERO_TENANT_ID", date="2019-03-31"
        )
        ```
        """
    ...
    async def get_profit_and_loss(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_profit_and_loss(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            from_date="2019-10-31",
            payments_only=False,
            periods=3,
    ...
    async def get_ten_ninety_nine(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_ten_ninety_nine(
            xero_tenant_id="YOUR_XERO_TENANT_ID", report_year="2019"
        )
        ```
        """
    ...
    async def get_trial_balance(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get_trial_balance(
            xero_tenant_id="YOUR_XERO_TENANT_ID", date="2019-10-31", payments_only=True
        )
        ```
        """
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.reports.get(
            report_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
