...
res = client.accounting.quotes.list(
...
res = await client.accounting.quotes.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    contact_id="00000000-0000-0000-0000-000000000000",
    date_from="2019-10-31",
    date_to="2019-10-31",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.quotes.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.quotes.get(
    quote_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.quotes.get_as_pdf(
    quote_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.quotes.get_as_pdf(
    quote_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.quotes.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    quotes=[
        {
            "date": "2020-02-01",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.quotes.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    quotes=[
        {
            "date": "2020-02-01",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.quotes.update(
    quote_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.quotes.update(
    quote_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    quotes=[{"date": "2020-02-01", "reference": "I am an update"}],
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.quotes.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    quotes=[
        {
            "date": "2020-02-01",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.quotes.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    quotes=[
        {
            "date": "2020-02-01",
