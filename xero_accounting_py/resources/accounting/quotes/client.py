...
from xero_accounting_py.resources.accounting.quotes.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.quotes.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class QuotesClient:
    ...
    def get_as_pdf(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.quotes.get_as_pdf(
            quote_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.quotes.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            quotes=[
                {
                    "date": "2020-02-01",
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.quotes.update(
            quote_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.quotes.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            quotes=[
                {
                    "date": "2020-02-01",
...
class AsyncQuotesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            contact_id="00000000-0000-0000-0000-000000000000",
            date_from="2019-10-31",
            date_to="2019-10-31",
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.get(
            quote_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def get_as_pdf(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.get_as_pdf(
            quote_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            quotes=[
                {
                    "date": "2020-02-01",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.update(
            quote_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            quotes=[{"date": "2020-02-01", "reference": "I am an update"}],
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.quotes.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            quotes=[
                {
                    "date": "2020-02-01",
