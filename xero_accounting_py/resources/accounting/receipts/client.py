...
from xero_accounting_py.resources.accounting.receipts.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.receipts.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class ReceiptsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.receipts.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.receipts.get(
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.receipts.update(
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            receipts=[
                {
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.receipts.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            receipts=[
                {
...
class AsyncReceiptsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.receipts.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="ReceiptNumber ASC",
            unitdp=4,
            where='Status=="DRAFT"',
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.receipts.get(
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            unitdp=4,
        )
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.receipts.update(
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            receipts=[
                {
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.receipts.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            receipts=[
                {
                    "line_amount_types": "NoTax",
