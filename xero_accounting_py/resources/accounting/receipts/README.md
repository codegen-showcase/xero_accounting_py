...
res = client.accounting.receipts.list(
...
res = await client.accounting.receipts.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="ReceiptNumber ASC",
    unitdp=4,
    where='Status=="DRAFT"',
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.receipts.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.receipts.get(
    receipt_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    unitdp=4,
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.receipts.update(
    receipt_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    receipts=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.receipts.update(
    receipt_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    receipts=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.receipts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    receipts=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.receipts.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    receipts=[
        {
            "line_amount_types": "NoTax",
