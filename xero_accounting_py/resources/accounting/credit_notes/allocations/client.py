...
class AllocationsClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.credit_notes.allocations.delete(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.credit_notes.allocations.create(
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            allocations=[
                {
...
class AsyncAllocationsClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.credit_notes.allocations.delete(
            allocation_id="00000000-0000-0000-0000-000000000000",
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.credit_notes.allocations.create(
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            allocations=[
                {
