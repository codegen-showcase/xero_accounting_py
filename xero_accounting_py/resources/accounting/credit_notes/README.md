...
res = client.accounting.credit_notes.list(
...
res = await client.accounting.credit_notes.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="CreditNoteNumber ASC",
    page=1,
    page_size=100,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.credit_notes.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.credit_notes.get(
    credit_note_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    unitdp=4,
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.credit_notes.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
            "date": "2019-01-05",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.credit_notes.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
            "date": "2019-01-05",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.credit_notes.update(
    credit_note_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.credit_notes.update(
    credit_note_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.credit_notes.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
            "date": "2019-01-05",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.credit_notes.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    credit_notes=[
        {
            "date": "2019-01-05",
