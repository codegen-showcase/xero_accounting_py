...
from xero_accounting_py.resources.accounting.credit_notes.allocations import (
    AllocationsClient,
    AsyncAllocationsClient,
)
from xero_accounting_py.resources.accounting.credit_notes.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.credit_notes.history import (
    AsyncHistoryClient,
    HistoryClient,
)
from xero_accounting_py.resources.accounting.credit_notes.pdf import (
    AsyncPdfClient,
    PdfClient,
)
...
class CreditNotesClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.credit_notes.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.credit_notes.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            credit_notes=[
                {
                    "date": "2019-01-05",
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.credit_notes.update(
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            credit_notes=[
                {
...
class AsyncCreditNotesClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.credit_notes.get(
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            unitdp=4,
        )
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.credit_notes.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            credit_notes=[
                {
                    "date": "2019-01-05",
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.credit_notes.update(
            credit_note_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            credit_notes=[
                {
