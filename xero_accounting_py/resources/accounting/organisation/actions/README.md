# accounting.organisation.actions
...
res = client.accounting.organisation.actions.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
res = await client.accounting.organisation.actions.list(
