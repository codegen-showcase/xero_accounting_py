...
res = client.accounting.organisation.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
...
res = await client.accounting.organisation.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
```
