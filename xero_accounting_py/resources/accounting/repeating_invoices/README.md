...
res = client.accounting.repeating_invoices.list(
...
res = await client.accounting.repeating_invoices.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", order="Total ASC", where='Status=="DRAFT"'
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.repeating_invoices.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.repeating_invoices.get(
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.repeating_invoices.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    repeating_invoices=[
        {
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.repeating_invoices.update_or_create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    repeating_invoices=[
        {
            "approved_for_sending": False,
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.repeating_invoices.update(
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.repeating_invoices.update(
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.repeating_invoices.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    repeating_invoices=[
        {
            "approved_for_sending": False,
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.repeating_invoices.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    repeating_invoices=[
        {
            "approved_for_sending": False,
