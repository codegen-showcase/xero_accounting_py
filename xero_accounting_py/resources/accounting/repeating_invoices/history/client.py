...
class HistoryClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.history.list(
        ...
        return self._base_client.request(
            method="GET",
            path=f"/RepeatingInvoices/{repeating_invoice_id}/History",
    ...
    def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.history.create_record(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncHistoryClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.history.list(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.history.create_record(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            history_records=[{"details": "Hello World"}],
        )
