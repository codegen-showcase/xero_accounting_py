...
from xero_accounting_py.resources.accounting.repeating_invoices.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.repeating_invoices.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class RepeatingInvoicesClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.get(
    ...
    def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            repeating_invoices=[
                {
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.update(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.repeating_invoices.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            repeating_invoices=[
                {
                    "approved_for_sending": False,
...
class AsyncRepeatingInvoicesClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Total ASC",
            where='Status=="DRAFT"',
        )
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.get(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def update_or_create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.update_or_create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            repeating_invoices=[
                {
                    "approved_for_sending": False,
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.update(
            repeating_invoice_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.repeating_invoices.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            repeating_invoices=[
                {
                    "approved_for_sending": False,
