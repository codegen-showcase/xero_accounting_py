...
res = client.accounting.bank_transfers.list(
...
res = await client.accounting.bank_transfers.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    order="Amount ASC",
    where="HasAttachments==true",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transfers.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transfers.get(
    bank_transfer_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
...
| ---------------- | :------: | -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `xero_tenant_id` |    ✓     | Xero identifier for Tenant | `"YOUR_XERO_TENANT_ID"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `bank_transfers` |    ✗     |                            | `[{"amount": 123.0, "created_date_utc": "/Date(1573755038314)/", "from_bank_account": {"account_id": "00000000-0000-0000-0000-000000000000", "code": "4400", "currency_code": "AUD", "has_attachments": False, "name": "Food Sales", "updated_date_utc": "/Date(1573755038314)/"}, "from_is_reconciled": False, "has_attachments": False, "to_bank_account": {"account_id": "00000000-0000-0000-0000-000000000000", "code": "4400", "currency_code": "AUD", "has_attachments": False, "name": "Food Sales", "updated_date_utc": "/Date(1573755038314)/"}, "to_is_reconciled": False}]` |
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.bank_transfers.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transfers=[
        {
            "amount": 50.0,
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.bank_transfers.create(
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    bank_transfers=[
        {
            "amount": 50.0,
