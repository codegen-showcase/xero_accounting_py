...
from xero_accounting_py.resources.accounting.bank_transfers.attachments import (
    AsyncAttachmentsClient,
    AttachmentsClient,
)
from xero_accounting_py.resources.accounting.bank_transfers.history import (
    AsyncHistoryClient,
    HistoryClient,
)
...
class BankTransfersClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transfers.list(
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transfers.get(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.accounting.bank_transfers.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transfers=[
                {
                    "amount": 50.0,
...
class AsyncBankTransfersClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transfers.list(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            order="Amount ASC",
            where="HasAttachments==true",
        )
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transfers.get(
            bank_transfer_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.accounting.bank_transfers.create(
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            bank_transfers=[
                {
                    "amount": 50.0,
