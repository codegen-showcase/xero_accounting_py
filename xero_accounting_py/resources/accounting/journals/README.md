...
res = client.accounting.journals.list(
...
res = await client.accounting.journals.list(
    xero_tenant_id="YOUR_XERO_TENANT_ID", offset=10, payments_only=True
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.accounting.journals.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.accounting.journals.get(
    journal_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
```
