...
class AttachmentsClient:
    ...
    def get_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        client.receipts.attachments.get_by_filename(
            content_type="image/jpg",
        ...
        return self._base_client.request(
            method="GET",
            path=f"/Receipts/{receipt_id}/Attachments/{file_name}",
            auth_names=["OAuth2"],
            headers=_header,
            cast_to=BinaryResponse,
            request_options=request_options or default_request_options(),
    ...
    def update_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        client.receipts.attachments.update_by_filename(
            data="string",
            file_name="xero-dev.jpg",
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    def create_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        client.receipts.attachments.create_by_filename(
            data="string",
            file_name="xero-dev.jpg",
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncAttachmentsClient:
    ...
    async def get_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        await client.receipts.attachments.get_by_filename(
            content_type="image/jpg",
            file_name="xero-dev.jpg",
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    async def update_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        await client.receipts.attachments.update_by_filename(
            data="string",
            file_name="xero-dev.jpg",
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
    ...
    async def create_by_filename(
        ...
        *,
        ...
        Examples:
        ```py
        await client.receipts.attachments.create_by_filename(
            data="string",
            file_name="xero-dev.jpg",
            receipt_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
