...
res = client.projects.projects1.list(xero_tenant_id="string", page=1, page_size=100)
```
...
res = await client.projects.projects1.list(
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.projects.projects1.get(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.projects.projects1.get(
    project_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", xero_tenant_id="string"
)
```
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.projects.projects1.patch(
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.projects.projects1.patch(
    project_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    status="INPROGRESS",
    xero_tenant_id="string",
)
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.projects.projects1.create(
    name="New Kitchen",
    xero_tenant_id="string",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.projects.projects1.create(
    name="New Kitchen",
    xero_tenant_id="string",
    contact_id="00000000-0000-0000-000-000000000000",
    deadline_utc="2019-12-10T12:59:59Z",
...
client = Client(oauth_token=getenv("API_TOKEN"))
res = client.projects.projects1.update(
    name="New Kitchen",
    project_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    xero_tenant_id="string",
...
client = AsyncClient(oauth_token=getenv("API_TOKEN"))
res = await client.projects.projects1.update(
    name="New Kitchen",
    project_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
    xero_tenant_id="string",
    contact_id="01234567-89ab-cdef-0123-456789abcdef",
