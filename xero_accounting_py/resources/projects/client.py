...
from xero_accounting_py.resources.projects.tasks import AsyncTasksClient, TasksClient
from xero_accounting_py.resources.projects.time import AsyncTimeClient, TimeClient
...
class ProjectsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.projects.list(xero_tenant_id="string", page=1, page_size=100)
        ```
        """
        _query: QueryParams = {}
...
class AsyncProjectsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.projects.list(xero_tenant_id="string", page=1, page_size=100)
        ```
        """
        _query: QueryParams = {}
        if not isinstance(contact_id, type_utils.NotGiven):
