...
### Retrieves a specific attachment from a specific repeating invoices by file name <a name="get_by_filename"></a>

**API Endpoint**: `GET /RepeatingInvoices/{RepeatingInvoiceID}/Attachments/{FileName}`
...
res = client.repeating_invoices.attachments.get_by_filename(
    content_type="image/jpg",
...
res = await client.repeating_invoices.attachments.get_by_filename(
    content_type="image/jpg",
    file_name="xero-dev.jpg",
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
### Updates a specific attachment from a specific repeating invoices by file name <a name="update_by_filename"></a>

**API Endpoint**: `POST /RepeatingInvoices/{RepeatingInvoiceID}/Attachments/{FileName}`
...
res = client.repeating_invoices.attachments.update_by_filename(
    data="string",
    file_name="xero-dev.jpg",
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
res = await client.repeating_invoices.attachments.update_by_filename(
    data="string",
    file_name="xero-dev.jpg",
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
### Creates an attachment from a specific repeating invoices by file name <a name="create_by_filename"></a>

**API Endpoint**: `PUT /RepeatingInvoices/{RepeatingInvoiceID}/Attachments/{FileName}`
...
res = client.repeating_invoices.attachments.create_by_filename(
    data="string",
    file_name="xero-dev.jpg",
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
...
res = await client.repeating_invoices.attachments.create_by_filename(
    data="string",
    file_name="xero-dev.jpg",
    repeating_invoice_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
