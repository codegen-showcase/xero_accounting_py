...
res = client.overpayments.allocations.delete(
...
res = await client.overpayments.allocations.delete(
    allocation_id="00000000-0000-0000-0000-000000000000",
    overpayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
)
...
res = client.overpayments.allocations.create(
    overpayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    allocations=[
        {
...
res = await client.overpayments.allocations.create(
    overpayment_id="00000000-0000-0000-0000-000000000000",
    xero_tenant_id="YOUR_XERO_TENANT_ID",
    allocations=[
        {
