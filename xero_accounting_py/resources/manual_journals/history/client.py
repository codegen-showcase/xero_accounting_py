...
class HistoryClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.manual_journals.history.list(
    ...
    def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        client.manual_journals.history.create_record(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncHistoryClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.manual_journals.history.list(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        await client.manual_journals.history.create_record(
            manual_journal_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            history_records=[{"details": "Hello World"}],
        )
