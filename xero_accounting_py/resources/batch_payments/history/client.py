...
class HistoryClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.batch_payments.history.list(
    ...
    def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        client.batch_payments.history.create_record(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
...
class AsyncHistoryClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.batch_payments.history.list(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
        )
        ```
    ...
    async def create_record(
        ...
        *,
        ...
        Examples:
        ```py
        await client.batch_payments.history.create_record(
            batch_payment_id="00000000-0000-0000-0000-000000000000",
            xero_tenant_id="YOUR_XERO_TENANT_ID",
            history_records=[{"details": "Hello World"}],
        )
