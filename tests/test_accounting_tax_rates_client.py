...
def test_create_200_success_all_params() -> None:
    ...
    response = client.accounting.tax_rates.create(
...
async def test_await_create_200_success_all_params() -> None:
    ...
    response = await client.accounting.tax_rates.create(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        tax_rates=[
            {
                "can_apply_to_assets": True,
...
def test_update_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.tax_rates.update(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        tax_rates=[
            {
                "can_apply_to_assets": True,
...
async def test_await_update_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.tax_rates.update(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        tax_rates=[
            {
                "can_apply_to_assets": True,
...
def test_get_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.tax_rates.get(
...
async def test_await_get_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.tax_rates.get(
        tax_type="INPUT2", xero_tenant_id="YOUR_XERO_TENANT_ID"
    )
    try:
        pydantic.TypeAdapter(models.TaxRates).validate_python(response)
