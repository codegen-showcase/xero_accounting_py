...
def test_get_200_success_all_params() -> None:
    """Tests a GET request to the /Prepayments/{PrepaymentID} endpoint.
    ...
    response = client.accounting.prepayments.get(
        prepayment_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
        pydantic.TypeAdapter(models.Prepayments).validate_python(response)
...
async def test_await_get_200_success_all_params() -> None:
    ...
    response = await client.accounting.prepayments.get(
        prepayment_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
def test_list_200_success_required_only() -> None:
    """Tests a GET request to the /Prepayments endpoint.
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.prepayments.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Reference ASC",
        page=1,
        page_size=100,
...
async def test_await_list_200_success_required_only() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.prepayments.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Reference ASC",
        page=1,
        page_size=100,
