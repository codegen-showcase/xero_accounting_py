...
def test_create_200_success_all_params() -> None:
    ...
    response = client.accounting.tracking_categories.options.create(
...
async def test_await_create_200_success_all_params() -> None:
    ...
    response = await client.accounting.tracking_categories.options.create(
        tracking_category_id_path="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        name="string",
        status="ACTIVE",
...
def test_update_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.tracking_categories.options.update(
        tracking_category_id_path="00000000-0000-0000-0000-000000000000",
...
async def test_await_update_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.tracking_categories.options.update(
        tracking_category_id_path="00000000-0000-0000-0000-000000000000",
        tracking_option_id_path="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        name="string",
...
def test_delete_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.tracking_categories.options.delete(
...
async def test_await_delete_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.tracking_categories.options.delete(
        tracking_category_id="00000000-0000-0000-0000-000000000000",
        tracking_option_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
