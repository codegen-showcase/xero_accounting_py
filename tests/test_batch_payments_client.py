...
def test_create_200_success_required_only() -> None:
    ...
    response = client.batch_payments.create(
...
async def test_await_create_200_success_required_only() -> None:
    ...
    response = await client.batch_payments.create(
        xero_tenant_id="YOUR_XERO_TENANT_ID", summarize_errors=True
    )
    try:
        pydantic.TypeAdapter(models.BatchPayments).validate_python(response)
...
def test_update_200_success_all_params() -> None:
    ...
    response = client.batch_payments.update(
...
async def test_await_update_200_success_all_params() -> None:
    ...
    response = await client.batch_payments.update(
        batch_payment_id="00000000-0000-0000-0000-000000000000",
        status="string",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
...
def test_delete_200_success_all_params() -> None:
    ...
    response = client.batch_payments.delete(
...
async def test_await_delete_200_success_all_params() -> None:
    ...
    response = await client.batch_payments.delete(
        batch_payment_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        status="string",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
...
def test_get_200_success_all_params() -> None:
    ...
    response = client.batch_payments.get(
        batch_payment_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_get_200_success_all_params() -> None:
    ...
    response = await client.batch_payments.get(
        batch_payment_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
def test_list_200_success_required_only() -> None:
    ...
    response = client.batch_payments.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Date ASC",
...
async def test_await_list_200_success_required_only() -> None:
    ...
    response = await client.batch_payments.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Date ASC",
        where='Status=="AUTHORISED"',
    )
