...
def test_create_by_filename_200_success_all_params() -> None:
    """Tests a PUT request to the /BankTransactions/{BankTransactionID}/Attachments/{FileName} endpoint.
    ...
    response = client.bank_transactions.attachments.create_by_filename(
...
async def test_await_create_by_filename_200_success_all_params() -> None:
    ...
    response = await client.bank_transactions.attachments.create_by_filename(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_update_by_filename_200_success_all_params() -> None:
    """Tests a POST request to the /BankTransactions/{BankTransactionID}/Attachments/{FileName} endpoint.
    ...
    response = client.bank_transactions.attachments.update_by_filename(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
async def test_await_update_by_filename_200_success_all_params() -> None:
    ...
    response = await client.bank_transactions.attachments.update_by_filename(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_filename_200_success_all_params() -> None:
    """Tests a GET request to the /BankTransactions/{BankTransactionID}/Attachments/{FileName} endpoint.
    ...
    response = client.bank_transactions.attachments.get_by_filename(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
...
async def test_await_get_by_filename_200_success_all_params() -> None:
    ...
    response = await client.bank_transactions.attachments.get_by_filename(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_id_200_success_all_params() -> None:
    """Tests a GET request to the /BankTransactions/{BankTransactionID}/Attachments/{AttachmentID} endpoint.
    ...
    response = client.bank_transactions.attachments.get_by_id(
...
async def test_await_get_by_id_200_success_all_params() -> None:
    ...
    response = await client.bank_transactions.attachments.get_by_id(
        attachment_id="00000000-0000-0000-0000-000000000000",
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /BankTransactions/{BankTransactionID}/Attachments endpoint.
    ...
    response = client.bank_transactions.attachments.list(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.bank_transactions.attachments.list(
        bank_transaction_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
