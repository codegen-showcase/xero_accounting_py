...
def test_create_200_success_required_only() -> None:
    ...
    response = client.accounting.manual_journals.create(
...
async def test_await_create_200_success_required_only() -> None:
    ...
    response = await client.accounting.manual_journals.create(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        manual_journals=[
            {
                "attachments": [
...
def test_update_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.manual_journals.update(
...
async def test_await_update_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.manual_journals.update(
        manual_journal_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        manual_journals=[
            {
...
def test_update_or_create_200_success_required_only() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.manual_journals.update_or_create(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        manual_journals=[
            {
                "attachments": [
...
async def test_await_update_or_create_200_success_required_only() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.manual_journals.update_or_create(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        manual_journals=[
            {
                "attachments": [
...
def test_get_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.manual_journals.get(
        manual_journal_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_get_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.manual_journals.get(
        manual_journal_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
def test_list_200_success_required_only() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.manual_journals.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Date ASC",
        page=1,
        page_size=100,
...
async def test_await_list_200_success_required_only() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.manual_journals.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Date ASC",
        page=1,
        page_size=100,
