...
def test_get_by_id_200_success_all_params() -> None:
    ...
    response = client.accounting.bank_transfers.attachments.get_by_id(
...
async def test_await_get_by_id_200_success_all_params() -> None:
    ...
    response = await client.accounting.bank_transfers.attachments.get_by_id(
        attachment_id="00000000-0000-0000-0000-000000000000",
        bank_transfer_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_list_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.bank_transfers.attachments.list(
        bank_transfer_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.bank_transfers.attachments.list(
        bank_transfer_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
