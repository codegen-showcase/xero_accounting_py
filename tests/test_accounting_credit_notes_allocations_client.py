...
def test_create_200_success_required_only() -> None:
    ...
    response = client.accounting.credit_notes.allocations.create(
...
async def test_await_create_200_success_required_only() -> None:
    ...
    response = await client.accounting.credit_notes.allocations.create(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        summarize_errors=True,
    )
...
def test_delete_200_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.credit_notes.allocations.delete(
...
async def test_await_delete_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.credit_notes.allocations.delete(
        allocation_id="00000000-0000-0000-0000-000000000000",
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
