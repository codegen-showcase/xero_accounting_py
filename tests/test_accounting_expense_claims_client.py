...
def test_create_200_success_all_params() -> None:
    """Tests a PUT request to the /ExpenseClaims endpoint.
    ...
    response = client.accounting.expense_claims.create(
        xero_tenant_id="YOUR_XERO_TENANT_ID"
    )
    try:
        pydantic.TypeAdapter(models.ExpenseClaims).validate_python(response)
...
async def test_await_create_200_success_all_params() -> None:
    ...
    response = await client.accounting.expense_claims.create(
        xero_tenant_id="YOUR_XERO_TENANT_ID"
    )
    try:
        pydantic.TypeAdapter(models.ExpenseClaims).validate_python(response)
...
def test_update_200_success_all_params() -> None:
    """Tests a POST request to the /ExpenseClaims/{ExpenseClaimID} endpoint.
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.expense_claims.update(
...
async def test_await_update_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.expense_claims.update(
        expense_claim_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
def test_get_200_success_all_params() -> None:
    """Tests a GET request to the /ExpenseClaims/{ExpenseClaimID} endpoint.
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.expense_claims.get(
        expense_claim_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_get_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.expense_claims.get(
        expense_claim_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
def test_list_200_success_required_only() -> None:
    """Tests a GET request to the /ExpenseClaims endpoint.
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.expense_claims.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Status ASC",
...
async def test_await_list_200_success_required_only() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.expense_claims.list(
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        order="Status ASC",
        where='Status=="SUBMITTED"',
    )
