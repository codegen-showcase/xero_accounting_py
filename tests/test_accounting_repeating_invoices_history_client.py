...
def test_create_record_200_success_all_params() -> None:
    """Tests a PUT request to the /RepeatingInvoices/{RepeatingInvoiceID}/History endpoint.
    ...
    response = client.accounting.repeating_invoices.history.create_record(
...
async def test_await_create_record_200_success_all_params() -> None:
    ...
    response = await client.accounting.repeating_invoices.history.create_record(
        repeating_invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        history_records=[
            {
...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /RepeatingInvoices/{RepeatingInvoiceID}/History endpoint.
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.repeating_invoices.history.list(
        repeating_invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.repeating_invoices.history.list(
        repeating_invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
