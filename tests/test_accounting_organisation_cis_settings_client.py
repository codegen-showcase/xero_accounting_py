...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /Organisation/{OrganisationID}/CISSettings endpoint.
    ...
    Response : models.CisOrgSettings
    ...
    response = client.accounting.organisation.cis_settings.list(
        organisation_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
        pydantic.TypeAdapter(models.CisOrgSettings).validate_python(response)
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.accounting.organisation.cis_settings.list(
        organisation_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
