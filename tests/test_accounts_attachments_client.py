...
def test_create_by_filename_200_success_all_params() -> None:
    """Tests a PUT request to the /Accounts/{AccountID}/Attachments/{FileName} endpoint.
    ...
    response = client.accounts.attachments.create_by_filename(
...
async def test_await_create_by_filename_200_success_all_params() -> None:
    ...
    response = await client.accounts.attachments.create_by_filename(
        account_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_update_by_filename_200_success_all_params() -> None:
    """Tests a POST request to the /Accounts/{AccountID}/Attachments/{FileName} endpoint.
    ...
    response = client.accounts.attachments.update_by_filename(
        account_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
async def test_await_update_by_filename_200_success_all_params() -> None:
    ...
    response = await client.accounts.attachments.update_by_filename(
        account_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_filename_200_success_all_params() -> None:
    """Tests a GET request to the /Accounts/{AccountID}/Attachments/{FileName} endpoint.
    ...
    response = client.accounts.attachments.get_by_filename(
        account_id="00000000-0000-0000-0000-000000000000",
...
async def test_await_get_by_filename_200_success_all_params() -> None:
    ...
    response = await client.accounts.attachments.get_by_filename(
        account_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_id_200_success_all_params() -> None:
    """Tests a GET request to the /Accounts/{AccountID}/Attachments/{AttachmentID} endpoint.
    ...
    response = client.accounts.attachments.get_by_id(
        account_id="00000000-0000-0000-0000-000000000000",
...
async def test_await_get_by_id_200_success_all_params() -> None:
    ...
    response = await client.accounts.attachments.get_by_id(
        account_id="00000000-0000-0000-0000-000000000000",
        attachment_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /Accounts/{AccountID}/Attachments endpoint.
    ...
    response = client.accounts.attachments.list(
        account_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.accounts.attachments.list(
        account_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
