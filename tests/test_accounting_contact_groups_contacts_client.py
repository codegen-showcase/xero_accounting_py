...
def test_create_200_success_all_params() -> None:
    ...
    response = client.accounting.contact_groups.contacts.create(
...
async def test_await_create_200_success_all_params() -> None:
    ...
    response = await client.accounting.contact_groups.contacts.create(
        contact_group_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
        pagination={"item_count": 2, "page": 1, "page_count": 1, "page_size": 10},
        warnings=[{"message": "string"}],
...
def test_delete_204_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.contact_groups.contacts.delete(
        contact_group_id="00000000-0000-0000-0000-000000000000",
...
async def test_await_delete_204_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.contact_groups.contacts.delete(
        contact_group_id="00000000-0000-0000-0000-000000000000",
        contact_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
...
def test_delete_all_204_success_all_params() -> None:
    ...
    # tests calling sync method with example data
    client = Client(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = client.accounting.contact_groups.contacts.delete_all(
        contact_group_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    assert response is None
...
async def test_await_delete_all_204_success_all_params() -> None:
    ...
    # tests calling async method with example data
    client = AsyncClient(oauth_token="API_TOKEN", environment=SIDEKO_MOCK_SERVER)
    response = await client.accounting.contact_groups.contacts.delete_all(
        contact_group_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    assert response is None
