...
def test_create_by_filename_200_success_required_only() -> None:
    """Tests a PUT request to the /Invoices/{InvoiceID}/Attachments/{FileName} endpoint.
    ...
    response = client.invoices.attachments.create_by_filename(
        data="string",
...
async def test_await_create_by_filename_200_success_required_only() -> None:
    ...
    response = await client.invoices.attachments.create_by_filename(
        data="string",
        file_name="xero-dev.jpg",
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_update_by_filename_200_success_all_params() -> None:
    """Tests a POST request to the /Invoices/{InvoiceID}/Attachments/{FileName} endpoint.
    ...
    response = client.invoices.attachments.update_by_filename(
        data="string",
        file_name="xero-dev.jpg",
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
async def test_await_update_by_filename_200_success_all_params() -> None:
    ...
    response = await client.invoices.attachments.update_by_filename(
        data="string",
        file_name="xero-dev.jpg",
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_filename_200_success_all_params() -> None:
    """Tests a GET request to the /Invoices/{InvoiceID}/Attachments/{FileName} endpoint.
    ...
    response = client.invoices.attachments.get_by_filename(
...
async def test_await_get_by_filename_200_success_all_params() -> None:
    ...
    response = await client.invoices.attachments.get_by_filename(
        content_type="image/jpg",
        file_name="xero-dev.jpg",
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_id_200_success_all_params() -> None:
    """Tests a GET request to the /Invoices/{InvoiceID}/Attachments/{AttachmentID} endpoint.
    ...
    response = client.invoices.attachments.get_by_id(
...
async def test_await_get_by_id_200_success_all_params() -> None:
    ...
    response = await client.invoices.attachments.get_by_id(
        attachment_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /Invoices/{InvoiceID}/Attachments endpoint.
    ...
    response = client.invoices.attachments.list(
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.invoices.attachments.list(
        invoice_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
