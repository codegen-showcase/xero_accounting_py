...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /Organisation/Actions endpoint.
    ...
    response = client.organisation.actions.list(xero_tenant_id="YOUR_XERO_TENANT_ID")
    try:
        pydantic.TypeAdapter(models.Actions).validate_python(response)
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.organisation.actions.list(
