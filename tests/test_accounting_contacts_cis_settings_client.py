...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /Contacts/{ContactID}/CISSettings endpoint.
    ...
    response = client.accounting.contacts.cis_settings.list(
        contact_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
        pydantic.TypeAdapter(models.CisSettings).validate_python(response)
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.accounting.contacts.cis_settings.list(
        contact_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
