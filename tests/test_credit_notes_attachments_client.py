...
def test_create_by_filename_200_success_required_only() -> None:
    """Tests a PUT request to the /CreditNotes/{CreditNoteID}/Attachments/{FileName} endpoint.
    ...
    response = client.credit_notes.attachments.create_by_filename(
...
@pytest.mark.asyncio
async def test_await_create_by_filename_200_success_required_only() -> None:
    """Tests a PUT request to the /CreditNotes/{CreditNoteID}/Attachments/{FileName} endpoint.
    ...
    response = await client.credit_notes.attachments.create_by_filename(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_update_by_filename_200_success_all_params() -> None:
    """Tests a POST request to the /CreditNotes/{CreditNoteID}/Attachments/{FileName} endpoint.
    ...
    response = client.credit_notes.attachments.update_by_filename(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
async def test_await_update_by_filename_200_success_all_params() -> None:
    ...
    response = await client.credit_notes.attachments.update_by_filename(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        data="string",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_filename_200_success_all_params() -> None:
    """Tests a GET request to the /CreditNotes/{CreditNoteID}/Attachments/{FileName} endpoint.
    ...
    response = client.credit_notes.attachments.get_by_filename(
...
async def test_await_get_by_filename_200_success_all_params() -> None:
    ...
    response = await client.credit_notes.attachments.get_by_filename(
        content_type="image/jpg",
        credit_note_id="00000000-0000-0000-0000-000000000000",
        file_name="xero-dev.jpg",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_get_by_id_200_success_all_params() -> None:
    """Tests a GET request to the /CreditNotes/{CreditNoteID}/Attachments/{AttachmentID} endpoint.
    ...
    response = client.credit_notes.attachments.get_by_id(
...
async def test_await_get_by_id_200_success_all_params() -> None:
    ...
    response = await client.credit_notes.attachments.get_by_id(
        attachment_id="00000000-0000-0000-0000-000000000000",
        content_type="image/jpg",
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
...
def test_list_200_success_all_params() -> None:
    """Tests a GET request to the /CreditNotes/{CreditNoteID}/Attachments endpoint.
    ...
    response = client.credit_notes.attachments.list(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
...
async def test_await_list_200_success_all_params() -> None:
    ...
    response = await client.credit_notes.attachments.list(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    try:
