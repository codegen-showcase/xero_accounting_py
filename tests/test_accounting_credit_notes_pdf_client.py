...
def test_get_200_success_all_params() -> None:
    """Tests a GET request to the /CreditNotes/{CreditNoteID}/pdf endpoint.
    ...
    response = client.accounting.credit_notes.pdf.get(
...
async def test_await_get_200_success_all_params() -> None:
    ...
    response = await client.accounting.credit_notes.pdf.get(
        credit_note_id="00000000-0000-0000-0000-000000000000",
        xero_tenant_id="YOUR_XERO_TENANT_ID",
    )
    is_valid_binary = isinstance(response, BinaryResponse)
